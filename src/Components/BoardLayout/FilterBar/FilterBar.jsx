    ...
    <section className="mt-8 w-full flex flex-col md:flex-row items-center justify-between gap-4">
      ...
      <div className="relative w-full md:w-96 group">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all text-slate-700 dark:text-slate-200 placeholder:text-slate-400"
        />
      </div>
      ...
      <div className="flex items-center gap-2 w-full md:w-auto overflow-x-auto pb-2 md:pb-0 no-scrollbar">
        ...
        <button className="p-2.5 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl text-slate-500 hover:text-purple-600 transition-colors">
          <FiFilter />
        </button>
        ...
        <div className="flex items-center gap-2 bg-gray-100 dark:bg-slate-900/50 p-1.5 rounded-2xl border border-gray-200 dark:border-slate-800">
          {priorities.map((priority) => (
            <button
              ...
              className={`
                px-4 py-1.5 rounded-xl text-sm font-medium transition-all duration-200 whitespace-nowrap
